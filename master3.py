# -*- coding: utf-8 -*-
"""
Created on Mon Jun 15 14:33:22 2020
...
trial = set([find(db,i) for i in range(len(db.index))])
...
'''
archetypeList2 = archetypeList[archetypeList['Restriction'] != 'Card']
archetypeList3 = archetypeList[~archetypeList.index.isin(archetypeList2.index)]
archetypeList4 = archetypeList3[~archetypeList3['Archetype'].isin(archetypeList2['Archetype'])]
archetypeList5 = archetypeList3[~archetypeList3['Archetype'].isin(archetypeList4['Archetype'])]
archetypeList5['Restriction'] = archetypeList5['Restriction'].str.replace('^Card','Spell/Trap')
archetypeList4 = pd.concat([archetypeList5,archetypeList4])
